  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* NÚT THÊM VÀO GIỎ - ĐÃ THÊM ONCLICK */}
        <button
          onClick={handleAddToCart}
          style={{ backgroundColor: accentColor }}
          className="w-full py-4 rounded-[25px] text-white font-black uppercase tracking-widest flex items-center justify-center gap-3 shadow-lg hover:brightness-110 active:scale-95 transition-all mb-6"
        >
        ...
        <div className="flex items-center justify-between w-full px-2">
          <button
            style={{ color: accentColor }}
            className="flex items-center gap-2 font-extrabold italic text-xs uppercase group/btn"
          >
            Xem chi tiết
